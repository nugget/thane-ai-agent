...
[`anthropic.go:applyCacheBreakpointGuards`](../internal/model/fleet/providers/anthropic.go):
...
- [`internal/model/fleet/providers/anthropic.go`](../internal/model/fleet/providers/anthropic.go) — `applyCacheBreakpointGuards` (enforcement)
