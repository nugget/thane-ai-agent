...
func NewAnticipationTools(store *AnticipationStore) *AnticipationTools {
	return &AnticipationTools{store: store}
}
...
func (t *AnticipationTools) listAnticipations() (string, error) {
...
func (t *AnticipationTools) resolveAnticipation(args map[string]any) (string, error) {
	id, _ := args["id"].(string)
	if id == "" {
...
func (t *AnticipationTools) cancelAnticipation(args map[string]any) (string, error) {
	id, _ := args["id"].(string)
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
