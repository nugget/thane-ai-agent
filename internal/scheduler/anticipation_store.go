...
func (s *AnticipationStore) migrate() error {
	_, err := s.db.Exec(`
...
func (s *AnticipationStore) scanRows(rows *sql.Rows) ([]*Anticipation, error) {
...
func (s *AnticipationStore) matches(a *Anticipation, ctx WakeContext) bool {
	t := a.Trigger
