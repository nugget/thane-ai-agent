...
- File tool paths must be literal filesystem paths. Shell expansion ($HOME, $(whoami), ~user) does NOT work in file tools. Use absolute paths like /Users/aimee/Documents or ~/Documents.
