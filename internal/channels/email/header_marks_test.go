...
func TestHeaderMarks(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "List-Help", raw: headerBlock("List-Help: <mailto:help@example.com>"), want: HeaderMarks{Bulk: true}},
		{name: "List-Unsubscribe", raw: headerBlock("List-Unsubscribe: <mailto:leave@example.com>"), want: HeaderMarks{Bulk: true}},
		{name: "List-Subscribe", raw: headerBlock("List-Subscribe: <mailto:join@example.com>"), want: HeaderMarks{Bulk: true}},
		{name: "List-Post", raw: headerBlock("List-Post: <mailto:list@example.com>"), want: HeaderMarks{Bulk: true}},
		{name: "List-Owner", raw: headerBlock("List-Owner: <mailto:owner@example.com>"), want: HeaderMarks{Bulk: true}},
		{name: "List-Archive", raw: headerBlock("List-Archive: <https://lists.example.com/archive>"), want: HeaderMarks{Bulk: true}},
		{name: "lower-case list field name", raw: headerBlock("list-archive: <https://lists.example.com/archive>"), want: HeaderMarks{Bulk: true}},
		...
		{name: "Precedence junk", raw: headerBlock("Precedence: junk"), want: HeaderMarks{Bulk: true, junkOnly: true}},
		{name: "Precedence junk beside a list field", raw: headerBlock("Precedence: junk", "List-Id: <family.lists.example.com>"), want: HeaderMarks{Bulk: true}},
		{name: "Precedence junk beside Precedence bulk", raw: headerBlock("Precedence: junk", "Precedence: bulk"), want: HeaderMarks{Bulk: true}},
