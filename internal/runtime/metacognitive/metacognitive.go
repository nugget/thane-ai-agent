...
// wiring: the write tool (replace_output_metacognitive_state) and the
// read-side document tools are generated from the spec's declared
// outputs during app hydration, and the model is the document's only
// author, through that generated tool.
