...
func (r *Registry) registerForgeSubscriptionTools() {
	...
	r.Register(&Tool{
		...
		Description: "Follow a code forge repository for new releases and/or commits. Polling runs only when forge subscription polling is enabled in config.",
		Parameters: map[string]any{
			...
			"properties": map[string]any{
				...
				"name": map[string]any{
					"type":        "string",
					"description": "Optional friendly name for notifications",
				},
	...
	r.Register(&Tool{
		...
		Description: "List code forge repository subscriptions with tracking settings and latest observed release/commit.",
		Parameters: map[string]any{
			"type":       "object",
			"properties": map[string]any{},
		},
