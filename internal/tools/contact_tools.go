		...
		Parameters: map[string]any{
			...
			"properties": map[string]any{
				...
				"query": map[string]any{
					"type":        "string",
					"description": "Words to search for in names, nicknames, notes, AI summaries and organizations; returns up to 50 matching contacts as a list, and says so when it stops at 50, because other contacts may match too.",
				},
				"kind": map[string]any{
					"type":        "string",
					"enum":        []string{"individual", "group", "org", "location"},
