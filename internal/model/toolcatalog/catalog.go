...
var builtinToolSpecs = map[string]BuiltinToolSpec{
	...
	"repo_git_blame":                {CanonicalID: "native:repo_git_blame", Source: NativeToolSource, Tags: []string{"files"}},
	"repo_git_diff":                 {CanonicalID: "native:repo_git_diff", Source: NativeToolSource, Tags: []string{"files"}},
	"repo_git_log":                  {CanonicalID: "native:repo_git_log", Source: NativeToolSource, Tags: []string{"files"}},
	"repo_git_show":                 {CanonicalID: "native:repo_git_show", Source: NativeToolSource, Tags: []string{"files"}},
	...
	"queue_status":                  {CanonicalID: "native:queue_status", Source: NativeToolSource, Tags: []string{"diagnostics"}},
	"system_health":                 {CanonicalID: "native:system_health", Source: NativeToolSource, Tags: []string{"diagnostics"}},
	...
	"watch_entity":                  {CanonicalID: "native:watch_entity", Source: NativeToolSource, Tags: []string{"loops"}},
	"unwatch_entity":                {CanonicalID: "native:unwatch_entity", Source: NativeToolSource, Tags: []string{"loops"}},
	"loop_activity":                 {CanonicalID: "native:loop_activity", Source: NativeToolSource, Tags: []string{"diagnostics"}},
	"loop_status":                   {CanonicalID: "native:loop_status", Source: NativeToolSource, Tags: []string{"loops", "diagnostics"}},
	"loop_containers":               {CanonicalID: "native:loop_containers", Source: NativeToolSource, Tags: []string{"loops", "diagnostics"}},
	...
	"companion_last_known_location": {CanonicalID: "native:companion_last_known_location", Source: NativeToolSource, Tags: []string{"companion"}},
